...
<div class='cards'>
    ...
    <div class='cards__title'>
        ...
        <div class='cards__title--icons'>
            <i class='cards__title--icon' @click="SwitchDisplayMode('card')"><os-filter height='20px' width='20px'/></i>
            <i class='cards__title--icon' @click="SwitchDisplayMode('list')"><os-filter height='20px' width='20px'/></i>
        </div>
