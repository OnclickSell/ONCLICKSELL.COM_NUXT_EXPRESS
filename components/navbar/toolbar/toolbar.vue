<template>
  <!-- Main Top navigation bar -->
    <nav class='navbar' :class="{'navbar--fixed': isNavOpen}">
        ...
        <os-logo class="navbar__logo" link="/"/>


        <os-menu class="menu" v-if="!isNavOpen"/>

        <span class='navbar__icon navbar__icon--hamburger' @click='openNav'>
            <os-hamburger height="50px" width="60px"/>
        </span>

        <os-slider class="slider" v-if="isNavOpen"/>
