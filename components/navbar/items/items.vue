<template>
    <ul class="items__container">
        <os-item class='navbar__list--item' v-on:clicked="navigate_to('/collections')" title="COLLECTIONS"/>
        <os-item class='navbar__list--item' v-on:clicked="logout" title="LOG OUT"/>
        <os-item class='navbar__list--item' v-on:clicked="navigate_to('/sell')" title="SELL"/>
        <os-item class='navbar__list--item' v-on:clicked="navigate_to('/register')" title="SIGN UP"/>
        <os-item class='navbar__list--item' v-on:clicked="navigate_to('/login')" title="SIGN IN"/>
    </ul>
</template>
