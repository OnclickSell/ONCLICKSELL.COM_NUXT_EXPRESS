<template>
  <!-- Main Top navigation bar -->
    <div class='navbar' :class="{'navbar--fixed': isNavOpen}">
        <nuxt-link tag="span" to="/" class='navbar__logo'></nuxt-link>
        <span class='navbar__icon navbar__icon--hamburger' @click='openNav'><os-hamburger height="50px" width="60px"/></span>
        <!-- <span class='navbar__icon navbar__icon--close'>Close</span> -->

        <transition name="navbar">
            <ul class='navbar__list' v-show='isNavOpen' @click="openNav">
                <li class='navbar__list--item navbar__profile' v-if='isAuth'>
                    <nuxt-link tag="span" to="/profile" class='navbar__profile--avatar navbar__icon'></nuxt-link>
                    {{ user.email }}
                    <span class='navbar__profile--notifications navbar__icon'><i>45</i></span>
                </li>
                <li class='navbar__list--item' v-if="isAuth"><span>COLLECTIONS</span></li>
                <li class='navbar__list--item' v-if="isAuth"><span @click="logout">LOG OUT</span></li>
                <li class='navbar__list--item' v-if="!isAuth"><nuxt-link tag="span" to="/about_us">ABOUT US</nuxt-link></li>
                <li class='navbar__list--item'><nuxt-link tag="span" to="/sell">SELL</nuxt-link></li>
                <li class='navbar__list--item' v-if="!isAuth"><nuxt-link tag="span" to="/register">SIGN UP</nuxt-link></li>
                <li class='navbar__list--item' v-if="!isAuth"><nuxt-link tag="span" to="/login">LOGIN</nuxt-link></li>
            </ul>
        </transition>
...
.navbar__logo {
    @include layout--item;
    // width: 50px;
    background-image: url('http://res.cloudinary.com/onclicksell-com/image/upload/v1513482432/OnclickSell.com/Logos/Onclicksell.com-160px-logo.svg');
