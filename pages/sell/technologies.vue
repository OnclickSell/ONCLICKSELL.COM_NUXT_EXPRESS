    ...
    <div>
        <div class='frontend'>
            ...
            <div class='frontend__item'>
                <os-input--drop-down item="name" v-if="added_technologies.plateform !== 'No'" :placeholder="frontend_tehnologies.plateform.name" v-model="setPlateform" :items="technologies.frontend.plateform"/>
            </div>

            <div class='frontend__item'>
                <os-input--drop-down item="version" v-if="added_technologies.plateform !== 'No'" :placeholder="frontend_tehnologies.plateform.version" v-model="set_plateform_version" :items="get_plateform_version"/>
            </div>
            ...
            <div class='frontend__item'>
                <os-input--drop-down v-if="added_technologies.framework !== 'No'" item="name" :placeholder="frontend_tehnologies.framework.name" v-model="setFramework" :items="technologies.frontend.framework"/>
            </div>

            <div class='frontend__item'>
                <os-input--drop-down v-if="added_technologies.framework !== 'No'" item="version" :placeholder="frontend_tehnologies.framework.version" v-model="set_framework_version" :items="get_framework_version"/>
            </div>
            ...
            <div class='frontend__item'>
                <os-input--drop-down v-if="added_technologies.libraries !== 'No'" item="name" :placeholder="frontend_tehnologies.libraries.name" v-model="setLibraries" :items="technologies.frontend.libraries"/>
            </div>

            <div class='frontend__item'>
                <os-input--drop-down v-if="added_technologies.libraries !== 'No'" item="version" :placeholder="frontend_tehnologies.libraries.version" v-model="set_libraries_version" :items="get_libraries_version"/>
            </div>
