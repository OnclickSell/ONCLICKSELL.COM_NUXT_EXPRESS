        ...
        <div class='l-login'>
            <div class='login'>
                <div class='l-login__inputs'>
                    ...
                    <button class='login__button' @click="resetPassword" v-if="!loading">Reset Password</button>
                ...
                <div class='l-login__github'>
                    ...
                    <p class='login__create-acount'>Create a new account</p>
                </div>
            </div>
        </div>   
  ...
  methods: {
    resetPassword () {
      ...
      // })
        ...
        this.$store.dispatch('authentication/resetPassword', newData)
